...
UPDATE `trinity_string` SET `content_loc3`='Ihr Passwort kann nicht länger als 16 Zeichen sein (Client Limit). Das Passwort wurde nicht geändert!' WHERE (`entry`='55');
...
UPDATE `trinity_string` SET `content_loc3`='Ihr könnt nicht zur Instanz des Spielers gehen, weil Ihr jetzt in einer Gruppe seid.' WHERE (`entry`='104');
...
UPDATE `trinity_string` SET `content_loc3`='Ihr könnt den Spieler nicht herbeirufen, da er in einer anderen Instanz ist.' WHERE (`entry`='107');
...
UPDATE `trinity_string` SET `content_loc3`='%s ändert Eure HP auf %i/%i.' WHERE (`entry`='119');
UPDATE `trinity_string` SET `content_loc3`='Ihr verändert MANA von %s auf %i/%i.' WHERE (`entry`='120');
UPDATE `trinity_string` SET `content_loc3`='%s ändert Euer MANA auf %i/%i.' WHERE (`entry`='121');
UPDATE `trinity_string` SET `content_loc3`='Ihr verändert die ENERGIE von %s auf %i/%i.' WHERE (`entry`='122');
UPDATE `trinity_string` SET `content_loc3`='%s veränderte Eure ENERGIE auf %i/%i.' WHERE (`entry`='123');
...
UPDATE `trinity_string` SET `content_loc3`='%s ändert Eure Wut auf %i/%i.' WHERE (`entry`='126');
UPDATE `trinity_string` SET `content_loc3`='Ihr ändert das Level von %s auf %i.' WHERE (`entry`='127');
...
UPDATE `trinity_string` SET `content_loc3`='Es gibt keine "teleport locations", die auf Eure Anfrage passen.' WHERE (`entry`='166');
UPDATE `trinity_string` SET `content_loc3`='Die gefundenen Orte sind:\n%s' WHERE (`entry`='168');
UPDATE `trinity_string` SET `content_loc3`='Mail gesendet zu %s' WHERE (`entry`='169');
...
UPDATE `trinity_string` SET `content_loc3`='Noch nicht eingebaut' WHERE (`entry`='205');
UPDATE `trinity_string` SET `content_loc3`='Item ''%i'' ''%s'' wurde zur Liste mit maxcount ''%i'' und incrtime ''%i'' und extendedcost ''%i'' hinzugefügt' WHERE (`entry`='206');
...
UPDATE `trinity_string` SET `content_loc3`='Unbekanntes Argument ''%s'' für den Befehl .resetall. Tippe den vollen, korrekten Argumentnamen ein.' WHERE (`entry`='217');
UPDATE `trinity_string` SET `content_loc3`='Zauber werden für alle Spieler beim nächsten Login zurückgesetzt. Es wird sehr empfohlen neu einzuloggen!' WHERE (`entry`='218');
UPDATE `trinity_string` SET `content_loc3`='Talente werden für alle Spieler beim nächsten Login zurückgesetzt. Es wird sehr empfohlen neu einzuloggen!' WHERE (`entry`='219');
...
UPDATE `trinity_string` SET `content_loc3`='Keine GUID bereitgestellt.' WHERE (`entry`='231');
UPDATE `trinity_string` SET `content_loc3`='Keine Nummer des Wegpunktes bereitgestellt.' WHERE (`entry`='232');
UPDATE `trinity_string` SET `content_loc3`='Benötige Argument für ''%s''.' WHERE (`entry`='233');
UPDATE `trinity_string` SET `content_loc3`='Wegpunkt %i hinzugefügt zu GUID: %d' WHERE (`entry`='234');
...
UPDATE `trinity_string` SET `content_loc3`='Text %d: %s' WHERE (`entry`='251');
UPDATE `trinity_string` SET `content_loc3`='AIScript: %s' WHERE (`entry`='252');
UPDATE `trinity_string` SET `content_loc3`='Erzwungenes Umbenennen für den Spieler %s wird beim nächsten Login gefordert werden.' WHERE (`entry`='253');
UPDATE `trinity_string` SET `content_loc3`='Erzwungenes Umbenennen für den Spieler %s (GUID #%u) wird beim nächsten Login gefordert werden.' WHERE (`entry`='254');
...
UPDATE `trinity_string` SET `content_loc3`='Warnung: Kreatur mehr als einmal gefunden - Ihr werden zur ersten teleportiert, die in der Datenbank gefunden wurde.' WHERE (`entry`='269');
UPDATE `trinity_string` SET `content_loc3`='Kreatur entfernt.' WHERE (`entry`='270');
UPDATE `trinity_string` SET `content_loc3`='Kreatur bewegt.' WHERE (`entry`='271');
UPDATE `trinity_string` SET `content_loc3`='Kreatur (GUID:%u) muss auf derselben Karte sein wie der Spieler!' WHERE (`entry`='272');
UPDATE `trinity_string` SET `content_loc3`='Game Object (GUID: %u) nicht gefunden' WHERE (`entry`='273');
UPDATE `trinity_string` SET `content_loc3`='Game Object (GUID: %u) ist abhängig von der nicht gefundenen Kreatur %u GO list, kann nicht gelöscht werden.' WHERE (`entry`='274');
UPDATE `trinity_string` SET `content_loc3`='Game Object (GUID: %u) entfernt' WHERE (`entry`='275');
UPDATE `trinity_string` SET `content_loc3`='Game Object (GUID: %u) gedreht' WHERE (`entry`='276');
UPDATE `trinity_string` SET `content_loc3`='Game Object (GUID: %u) bewegt' WHERE (`entry`='277');
...
UPDATE `trinity_string` SET `content_loc3`='Verkäufer hat zu viele Items (max 128)' WHERE (`entry`='280');
UPDATE `trinity_string` SET `content_loc3`='Ihr könnt Euch nicht selbst kicken, loggt Euch stattdessen aus' WHERE (`entry`='281');
UPDATE `trinity_string` SET `content_loc3`='Spieler |cffff0000%s|r gekickt von |cffff0000%s|r. Grund: |cffff0000%s|r.' WHERE (`entry`='282');
UPDATE `trinity_string` SET `content_loc3`='Spieler %s nicht gefunden.' WHERE (`entry`='283');
...
UPDATE `trinity_string` SET `content_loc3`='Euer Chat wurde für %u Minuten abgeschaltet.' WHERE (`entry`='300');
UPDATE `trinity_string` SET `content_loc3`='Ihr hab den Chat von %s für %u Minuten abgeschaltet.' WHERE (`entry`='301');
...
UPDATE `trinity_string` SET `content_loc3`=' [eigenes Team]' WHERE (`entry`='314');
...
UPDATE `trinity_string` SET `content_loc3`='GM-Modus ist ON' WHERE (`entry`='332');
UPDATE `trinity_string` SET `content_loc3`='GM-Modus ist OFF' WHERE (`entry`='333');
UPDATE `trinity_string` SET `content_loc3`='GM-Chat ist ON' WHERE (`entry`='334');
UPDATE `trinity_string` SET `content_loc3`='GM-Chat ist OFF' WHERE (`entry`='335');
...
UPDATE `trinity_string` SET `content_loc3`='Ihr habt den Waterwalk-Modus %s für %s gesetzt.' WHERE (`entry`='338');
UPDATE `trinity_string` SET `content_loc3`='Euer Waterwalk-Modus %s von %s.' WHERE (`entry`='339');
...
UPDATE `trinity_string` SET `content_loc3`='%s entbannt.' WHERE (`entry`='411');
...
UPDATE `trinity_string` SET `content_loc3`='Banndatum: %s Bannzeit: %s immer noch aktiv: %s  Grund: %s Von: %s' WHERE (`entry`='418');
...
UPDATE `trinity_string` SET `content_loc3`='Es gibt keinen übereinstimmenden IP-Bann.' WHERE (`entry`='424');
UPDATE `trinity_string` SET `content_loc3`='Es gibt keinen übereinstimmenden Account.' WHERE (`entry`='425');
UPDATE `trinity_string` SET `content_loc3`='Es gibt keinen gebannten Account dem ein Charakter gehört, der mit diesem Teil übereinstimmen würde.' WHERE (`entry`='426');
UPDATE `trinity_string` SET `content_loc3`='Die folgenden IPs entsprechende Eurem Muster:' WHERE (`entry`='427');
UPDATE `trinity_string` SET `content_loc3`='Die folgenden Account entsprechen Eurem Query:' WHERE (`entry`='428');
...
UPDATE `trinity_string` SET `content_loc3`='Friedhof #%u (faction: %s) ist der nähste von der verlinkten Zone #%u.' WHERE (`entry`='459');
UPDATE `trinity_string` SET `content_loc3`='Zone #%u hat keinen verlinkten Friedhof.' WHERE (`entry`='460');
UPDATE `trinity_string` SET `content_loc3`='Zone #%u hat keinen verlinkten Freidhof für die Fraktion: %s.' WHERE (`entry`='461');
...
UPDATE `trinity_string` SET `content_loc3`='id: %d eff: %d type: %d duration: %d maxduration: %d name: %s%s%s caster: %s %u' WHERE (`entry`='468');
UPDATE `trinity_string` SET `content_loc3`='Angewählte Einheit hat %d Auren des Typs %d:' WHERE (`entry`='469');
UPDATE `trinity_string` SET `content_loc3`='id: %d eff: %d name: %s%s%s caster: %s %u' WHERE (`entry`='470');
...
UPDATE `trinity_string` SET `content_loc3`='Charakter erfolgreich abgeladen!' WHERE (`entry`='481');
UPDATE `trinity_string` SET `content_loc3`='Abladen des Charakters gescheitert!' WHERE (`entry`='482');
...
UPDATE `trinity_string` SET `content_loc3`='Entferne itemID = %i, amount = %i von %s' WHERE (`entry`='496');
UPDATE `trinity_string` SET `content_loc3`='Kann Item ''%i'' (amount: %i) nicht herstellen' WHERE (`entry`='497');
...
UPDATE `trinity_string` SET `content_loc3`='Gilde wurde nicht erstellt! (existiert bereits?)' WHERE (`entry`='501');
UPDATE `trinity_string` SET `content_loc3`='Kein Item vom Itemset ''%u'' gefunden.' WHERE (`entry`='502');
UPDATE `trinity_string` SET `content_loc3`='Die Entfernung ist: (3D) %f (2D) %f yards.' WHERE (`entry`='503');
...
UPDATE `trinity_string` SET `content_loc3`='%d - |cffffffff|Hitem:%d:0:0:0:0:0:0:0|h[%s]|h|r ' WHERE (`entry`='512');
UPDATE `trinity_string` SET `content_loc3`='%d - |cffffffff|Hquest:%d|h[%s]|h|r %s' WHERE (`entry`='513');
...
UPDATE `trinity_string` SET `content_loc3`='%d - |cffffffff|Hskill:%d|h[%s %s]|h|r %s' WHERE (`entry`='521');
UPDATE `trinity_string` SET `content_loc3`='Game Object (GUID: %u) nicht gefunden' WHERE (`entry`='522');
UPDATE `trinity_string` SET `content_loc3`='>> Game Object %s (GUID: %u) bei %f %f %f. Orientierung %f.' WHERE (`entry`='523');
UPDATE `trinity_string` SET `content_loc3`='Ausgewähltes Objekt:\n|cffffffff|Hitemset:%d|h[%s]|h|r\nGUID: %u ID: %u\nX: %f Y: %f Z: %f MapId: %u\nOrientierung: %f' WHERE (`entry`='524');
UPDATE `trinity_string` SET `content_loc3`='>> Füge Game Object ''%i'' (%s) (GUID: %i) hinzu zu ''%f %f %f''.' WHERE (`entry`='525');
UPDATE `trinity_string` SET `content_loc3`='%s (lowguid: %u) Bewegungsgeneratoren sammeln:' WHERE (`entry`='526');
...
UPDATE `trinity_string` SET `content_loc3`='   Waypoint' WHERE (`entry`='529');
UPDATE `trinity_string` SET `content_loc3`='   Animal random' WHERE (`entry`='530');
...
UPDATE `trinity_string` SET `content_loc3`='   Home movement für (X:%f Y:%f Z:%f)' WHERE (`entry`='535');
UPDATE `trinity_string` SET `content_loc3`='   Home movement für Spieler gebraucht?!?' WHERE (`entry`='536');
...
UPDATE `trinity_string` SET `content_loc3`='Leben (base): %u. (max): %u. (derzeit): %u.' WHERE (`entry`='541');
UPDATE `trinity_string` SET `content_loc3`='Field Flags: %u.\nDynamic Flags: %u.\nFaction Template: %u.' WHERE (`entry`='542');
UPDATE `trinity_string` SET `content_loc3`='Loot: %u Pickpocket: %u Skinning: %u' WHERE (`entry`='543');
...
UPDATE `trinity_string` SET `content_loc3`='Spieler%s %s (guid: %u) Account: %s (id: %u) GMLevel: %u Letzte IP: %s Letzter Login: %s Latenz: %ums' WHERE (`entry`='548');
UPDATE `trinity_string` SET `content_loc3`='Gespielte Zeit: %s Level: %u Geld: %ug%us%uc' WHERE (`entry`='549');
...
UPDATE `trinity_string` SET `content_loc3`='Euer Level wurde erhöht (%i)' WHERE (`entry`='557');
UPDATE `trinity_string` SET `content_loc3`='Euer Level wurde erniedrigt (%i)' WHERE (`entry`='558');
UPDATE `trinity_string` SET `content_loc3`='Euer Levelfortschritt wurde zurückgesetzt.' WHERE (`entry`='559');
...
UPDATE `trinity_string` SET `content_loc3`='Der Wer des Index %u ist zu groß %u(Anzahl: %u).' WHERE (`entry`='564');
...
UPDATE `trinity_string` SET `content_loc3`='Ihr habt den Wert des Feldes:%u auf den Wert: %u erneuert' WHERE (`entry`='576');
...
UPDATE `trinity_string` SET `content_loc3`='Spieler %s hat alle Standartzauber seiner Rasse/Klasse und Zauber, die er durch abgeschlossenen Quests bekam, erlernt.' WHERE (`entry`='580');
UPDATE `trinity_string` SET `content_loc3`='Gefundene nahe Gameobjects (Distanz %f): %u ' WHERE (`entry`='581');
...
UPDATE `trinity_string` SET `content_loc3`='Die Flagge der Allianz wurde zurückgesetzt!' WHERE (`entry`='614');
UPDATE `trinity_string` SET `content_loc3`='Die Flagge der Horde wurde zurückgesetzt!' WHERE (`entry`='615');
...
UPDATE `trinity_string` SET `content_loc3`='Der %s hat %s eingenommen' WHERE (`entry`='657');
...
UPDATE `trinity_string` SET `content_loc3`='$n nimmt %s ein! Falls es nicht verteidigt, wird es die %s in 1 Minute kontrollieren!' WHERE (`entry`='660');
...
UPDATE `trinity_string` SET `content_loc3`='Die Allianz hat $1776W an Ressourcen gesammelt, und ist nahe eines Sieges!' WHERE (`entry`='664');
UPDATE `trinity_string` SET `content_loc3`='Die Horde hat $1777W an Ressourcen gesammelt, und ist nahe eines Sieges!' WHERE (`entry`='665');
...
UPDATE `trinity_string` SET `content_loc3`='$N hat die Flagge aufgenommen.' WHERE (`entry`='683');
...
UPDATE `trinity_string` SET `content_loc3`='Sie müssen mindestens Level %u haben um ein Arenateam zu gründen' WHERE (`entry`='700');
...
UPDATE `trinity_string` SET `content_loc3`='Stört nicht' WHERE (`entry`='709');
UPDATE `trinity_string` SET `content_loc3`='Abwesend von der Tastatur' WHERE (`entry`='710');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe ist zu groß für das Schlachtfeld. Bitte macht eine neue Gruppe um beizutreten.' WHERE (`entry`='711');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe ist zu groß für die Arena. Bitte macht eine neue Gruppe um beizutreten.' WHERE (`entry`='712');
...
UPDATE `trinity_string` SET `content_loc3`='Friedhof der Sturmlanzen' WHERE (`entry`='731');
...
UPDATE `trinity_string` SET `content_loc3`='Die Allianz hat nurnoch wenige Verstärkungspunkte' WHERE (`entry`='746');
UPDATE `trinity_string` SET `content_loc3`='Die Horde hat nurnoch wenige Verstärkungspunkte' WHERE (`entry`='747');
UPDATE `trinity_string` SET `content_loc3`='Der General der Horde ist tot!' WHERE (`entry`='748');
UPDATE `trinity_string` SET `content_loc3`='Der General der Allianz ist tot!' WHERE (`entry`='749');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe hat Mitglieder die nicht eurem Arenateam angehören. Bitte macht eine neue Gruppe um beizutreten.' WHERE (`entry`='770');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe hat nicht genug Spieler um beizutreten.' WHERE (`entry`='771');
UPDATE `trinity_string` SET `content_loc3`='Das goldene Team gewinnt.' WHERE (`entry`='772');
UPDATE `trinity_string` SET `content_loc3`='Das grüne Team gewinnt.' WHERE (`entry`='773');
UPDATE `trinity_string` SET `content_loc3`='Es gibt nicht genug Spieler auf diesem Schlachtfeld. Es endet bald, es sei denn, einige Spieler treten den Kampf bei.' WHERE (`entry`='774');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe hat einen Spieler der offline ist. Bitte entfernt ihn, bevor ihr beitritt' WHERE (`entry`='775');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe hat Spieler von der gegnerischen Fraktion. Ihr könnt nicht gemeinsam, als Gruppe beitreten!' WHERE (`entry`='776');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe hat Spieler aus verschiedenen Schlachtfeldern. Ihr können nicht als Gruppe beitreten.' WHERE (`entry`='777');
UPDATE `trinity_string` SET `content_loc3`='Einer aus eurer Gruppe ist bereits in der Warteschlange für das Schlachtfeld. Er/Sie muss die Gruppe verlassen, bevor ihr als Gruppe beitretet.' WHERE (`entry`='778');
UPDATE `trinity_string` SET `content_loc3`='Einer aus eurer Gruppe ist ein Desateur. Ihr könnt nicht als Gruppe beitreten.' WHERE (`entry`='779');
UPDATE `trinity_string` SET `content_loc3`='Einer aus eurer Gruppe ist bereits in drei Schlachtfeld-Warteschlangen. Ihr könnt nicht als Gruppe beitreten.' WHERE (`entry`='780');
UPDATE `trinity_string` SET `content_loc3`='Ihr könnt euch nicht in eine Schlachtfeld- oder Arena-Map teleportieren.' WHERE (`entry`='781');
UPDATE `trinity_string` SET `content_loc3`='Ihr könnt nicht Spieler in eine Schlachtfeld- oder Arena-Map beschwören.' WHERE (`entry`='782');
UPDATE `trinity_string` SET `content_loc3`='Ihr müsst euch im GM-Modus befinden, um Spieler in ein Schlachtfeld zu teleportieren.' WHERE (`entry`='783');
UPDATE `trinity_string` SET `content_loc3`='Ihr könnt euch nicht von einem Schlachtfeld zum nächsten Schlachtfeld teleportieren. Bitte verlasst zuerst das aktuelle Schlachtfeld.' WHERE (`entry`='784');
...
UPDATE `trinity_string` SET `content_loc3`='Ihr müsst euch in einer Schlachtgruppe befinden um der Instanz beizutretten %s!' WHERE (`entry`='810');
UPDATE `trinity_string` SET `content_loc3`='Ihr könnt nicht eintreten %s solange ihr im Geister-Modus seit.' WHERE (`entry`='811');
...
UPDATE `trinity_string` SET `content_loc3`='|    Account    |       Charakter      |       IP        | GM | TBC |' WHERE (`entry`='1010');
UPDATE `trinity_string` SET `content_loc3`='|<Fehler>       | %20s |<Fehler>         |<Fe>|<Feh>|' WHERE (`entry`='1011');
...
UPDATE `trinity_string` SET `content_loc3`='%d - %s %s %s' WHERE (`entry`='1109');
...
UPDATE `trinity_string` SET `content_loc3`='Charakter Guid %u wird verwendet!' WHERE (`entry`='1117');
...
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe ist für dieses Schlachtfeld zu groß. Bitte öffnet eine neue Gruppe, um beizutreten.' WHERE (`entry`='1122');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe ist für diese Arena zu groß. Bitte öffnet eine neue Gruppe, um beizutreten.' WHERE (`entry`='1123');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe hat Mitglieder, die sich nicht in Eurem Arenateam befinden. Bitte öffnet eine neue Gruppe, um beizutreten.' WHERE (`entry`='1124');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe hat nicht genug Spieler, um diesem Kampf beizutreten.' WHERE (`entry`='1125');
UPDATE `trinity_string` SET `content_loc3`='Das goldene Team gewinnt!' WHERE (`entry`='1126');
UPDATE `trinity_string` SET `content_loc3`='Das grüne Team gewinnt!' WHERE (`entry`='1127');
UPDATE `trinity_string` SET `content_loc3`='Es sind nicht genug Spieler in diesem Schlachtfeld. Es wird bald geschlössen, sollten nicht mehr Spieler beitreten, die den Kampf ausgleichen.' WHERE (`entry`='1128');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe hat einen Spieler der offline ist. Bitte entfernt ihn bevor ihr beitretet.' WHERE (`entry`='1129');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe hat Spieler von der anderen Fraktion. Ihr könnt dem Schlachtfeld nicht als Gruppe beitreten.' WHERE (`entry`='1130');
UPDATE `trinity_string` SET `content_loc3`='Eure Gruppe hat Spieler von verschiedenen Schlachtfeldtypen. Ihr könnt nicht als Gruppe beitreten.' WHERE (`entry`='1131');
UPDATE `trinity_string` SET `content_loc3`='Jemand aus Eurer Gruppe ist bereits in der Warteschlange dieses Schlachtfeldes. Er/Sie muss diese verlassen bevor Ihr Euch als Gruppe anmelden könnt.' WHERE (`entry`='1132');
UPDATE `trinity_string` SET `content_loc3`='Jemand aus Eurer Gruppe ist Deserteur. Ihr könnt nich als Gruppe beitreten.' WHERE (`entry`='1133');
UPDATE `trinity_string` SET `content_loc3`='Jemand aus Eurer Gruppe befindet sich bereits in drei Warteschlangen von Schlachtfeldern. Ihr könnt nicht als Gruppe beitreten.' WHERE (`entry`='1134');
UPDATE `trinity_string` SET `content_loc3`='Ihr könnt Euch nicht zu einem Schlachtfeld oder einer Arena teleportieren.' WHERE (`entry`='1135');
UPDATE `trinity_string` SET `content_loc3`='Ihr könnt keine Spieler zu einem Schlachtfeld oder einer Arena einladen.' WHERE (`entry`='1136');
UPDATE `trinity_string` SET `content_loc3`='Ihr müsst im GM-Modus sein, um Euch zu einen Spieler in einem Schlachtfeld zu teleportieren.' WHERE (`entry`='1137');
UPDATE `trinity_string` SET `content_loc3`='Ihr könnt Euch nicht von einem Schlachtfeld in eine anderes teleportieren. Bitte verlasst zuerst dieses Schlachtfeld.' WHERE (`entry`='1138');
...
UPDATE `trinity_string` SET `content_loc3`='Zeige Liste mit offnen Tickets.' WHERE (`entry`='2009');
UPDATE `trinity_string` SET `content_loc3`='Zeige Liste mit offnen Tickets an, wo deren Verfasser online ist.' WHERE (`entry`='2010');
UPDATE `trinity_string` SET `content_loc3`='Zeige Liste mit geschlossenen Tickets.' WHERE (`entry`='2011');
UPDATE `trinity_string` SET `content_loc3`='Ungültiger Name. Sollte von einen Gamemaster sein der online ist.' WHERE (`entry`='2012');
UPDATE `trinity_string` SET `content_loc3`='Dieses Ticket ist bereits ihnen zugeordnet. Um es neu zuzuweisen verwende .ticket neu zuordnen %d und ordne es neu zu.' WHERE (`entry`='2013');
UPDATE `trinity_string` SET `content_loc3`='Ticket %d ist nicht zugewiesen. Ihr könnt es nicht zuweisen.' WHERE (`entry`='2014');
UPDATE `trinity_string` SET `content_loc3`='Ihr könnt keine Tickets von Teammitglieder die ein höheres Sicherheitslevel haben als ihr, zuordnen.' WHERE (`entry`='2015');
UPDATE `trinity_string` SET `content_loc3`='Kan Ticket nicht schließen %d. Ist einen anderen GM zugeordnet.' WHERE (`entry`='2016');
...
UPDATE `trinity_string` SET `content_loc3`='|cff00ff00letzte Änderung|r:|cff00ccff %s vor|r ' WHERE (`entry`='2019');
UPDATE `trinity_string` SET `content_loc3`='|cff00ff00Zugewiesen zu|r:|cff00ccff %s|r ' WHERE (`entry`='2020');
UPDATE `trinity_string` SET `content_loc3`='|cff00ff00Nicht zugeordnet von|r:|cff00ccff %s|r ' WHERE (`entry`='2021');
...
UPDATE `trinity_string` SET `content_loc3`='Es ist zwar lustig, aber nein... ihr könnt euch nicht selbst einfrieren!' WHERE (`entry`='5001');
...
UPDATE `trinity_string` SET `content_loc3`='Sound %u wird abgespielt.' WHERE (`entry`='5009');
...
UPDATE `trinity_string` SET `content_loc3`='Gebt mir die Flagge, ich werde sie zum zentralen Leuchtsignal, für den Ruhm der Allianz, bringen!' WHERE (`entry`='10054');
UPDATE `trinity_string` SET `content_loc3`='Gebt mir die Flagge, ich werde sie zum zentralen Leuchtsignal, für den Ruhm der Horde, bringen!' WHERE (`entry`='10055');
UPDATE `trinity_string` SET `content_loc3`='Ihr müsst ein Mitglied der Horde sein. Um die Halle der Legenden beitreten zu können.' WHERE (`entry`='10056');
UPDATE `trinity_string` SET `content_loc3`='Ihr müsst Mitglied der Allianz sein. Um die Halle der Champions beitreten zu können' WHERE (`entry`='10057');
